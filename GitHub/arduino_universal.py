...
"""
sudo apt-get install libgtk-3-dev 22
...
class Mainwindow:
  ...
  def addressValueChange(self,Widget,*Data):
      for bt in range(1, iloscbt + 1):
         ...
         self.bt_table_id[Data[0]][bt] = self.bt_table[Data[0]][bt].connect('clicked',self.click,self.sb_address[Data[0]].get_value_as_int(),bt)
  ...
  def __init__(self):
      ...
      self.window.set_border_width(10)
      self.container = gtk.HBox(gtk.FALSE,zmienna)
      self.window.set_default_size((self.size_of_window*zmienna)+10*zmienna*iloscbt,(self.size_of_window*iloscbt)+10*zmienna*iloscbt)
      self.window.add(self.container)
      ...
      self.hbox_for_frame = {}
      self.bt_address = {}
      self.bt_table_id = [[1 for x in range(iloscbt+1)] for y in range(zmienna+1)]
      self.bt_table = [[1 for bt_x in range(iloscbt+1)] for bt_y in range(zmienna+1)]
      for num in range(1, zmienna+1):
          self.vBox[num] = gtk.VBox(gtk.FALSE, zmienna)
          self.container.add(self.vBox[num])
          self.vBox[num].show()

      for i in range(1,zmienna2+1):
          ...
          self.bt_address[i] = gtk.Button("Change")
          self.bt_address[i].connect("clicked", self.click_change_address,self.sb_adjustment[i].get_value(),self.sb_adjustment[i])
  ...
  #         self.activecheck(self)
  def on_togglebutton1_1_toggled(self, widget):forLedBlackOutSingle(False,self.check1_1,self.check1_2,self.toggle1_2,self.toggle1_3,2, 0, 0)
  def on_togglebutton2_1_toggled(self, widget):forLedBlackOutSingle(False,self.check2_1,self.check2_2,self.toggle2_2,self.toggle2_3,3, 0, 0)
  def on_togglebutton3_1_toggled(self, widget):forLedBlackOutSingle(False,self.check3_1,self.check3_2,self.toggle3_2,self.toggle3_3,4, 0, 0)
  def on_togglebutton4_1_toggled(self, widget):forLedBlackOutSingle(False,self.check4_1,self.check4_2,self.toggle4_2,self.toggle4_3,5, 0, 0)
  def on_togglebutton5_1_toggled(self, widget):forLedBlackOutSingle(False,self.check5_1,self.check5_2,self.toggle5_2,self.toggle5_3,6, 0, 0)

  def on_togglebutton1_2_toggled(self, widget):callFunctionLightLed(self, self.toggle1_2,self.check1_1, 2, 1, 1, 0)
  def on_togglebutton1_3_toggled(self, widget):callFunctionLightLed(self, self.toggle1_3,self.check1_2, 2, 1, 2, 0)

  def on_togglebutton2_2_toggled(self, widget):callFunctionLightLed(self, self.toggle2_2,self.check2_1, 3, 1, 1, 0)
  def on_togglebutton2_3_toggled(self, widget):callFunctionLightLed(self, self.toggle2_3,self.check2_2, 3, 1, 2, 0)

  def on_togglebutton3_2_toggled(self, widget):callFunctionLightLed(self, self.toggle3_2,self.check3_1, 4, 1, 1, 0)
  def on_togglebutton3_3_toggled(self, widget):callFunctionLightLed(self, self.toggle3_3,self.check3_2, 4, 1, 2, 0)

  def on_togglebutton4_2_toggled(self, widget):callFunctionLightLed(self, self.toggle4_2,self.check4_1, 5, 1, 1, 0)
  def on_togglebutton4_3_toggled(self, widget):callFunctionLightLed(self, self.toggle4_3,self.check4_2, 5, 1, 2, 0)

  def on_togglebutton5_2_toggled(self, widget):callFunctionLightLed(self, self.toggle5_2,self.check5_1, 6, 1, 1, 0)
  def on_togglebutton5_3_toggled(self, widget):callFunctionLightLed(self, self.toggle5_3,self.check5_2, 6, 1, 2, 0)
